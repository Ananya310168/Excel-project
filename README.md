...
Performed data cleaning (removed duplicates, handled missing values, standardized formats)
Organized data using sorting and filtering techniques for clarity and usability
Applied Excel formulas (SUM, AVERAGE, IF, VLOOKUP) for data analysis and calculations
Built Pivot Tables to efficiently summarize and analyze large datasets
Created visually appealing charts and graphs for better understanding of trends
Designed an interactive dashboard to present key insights in a user-friendly manner
...
<img width="1920" height="1080" alt="Screenshot (43)" src="https://github.com/user-attachments/assets/02a46b8a-071c-4864-bcd6-28d390b4d79e" />
